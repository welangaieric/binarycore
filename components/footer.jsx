    ...
    <footer className="w-full items-center justify-center flex py-6 bg-gray-100 dark:bg-gray-800">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              ...
              <li><Link href="/about" className="text-sm text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300">Team</Link></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li><a href="mailto:devlabskenya@gmail.com" className="text-sm text-gray-500 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300">devlabskenya@gmail.com</a></li>
        ...
        <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          © 2023 Devlabs. All rights reserved.
        </div>
      </div>
    </footer>
  )
